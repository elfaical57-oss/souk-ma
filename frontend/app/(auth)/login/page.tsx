      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-bold text-gray-900 mt-3">{t.auth.login_title}</h1>
            <p className="text-sm text-gray-500 mt-1">
              {lang === "ar" ? "أدخل رقم هاتفك لتسجيل الدخول" : "Entrez votre numéro pour vous connecter"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">
                {lang === "ar" ? "مثال: 0612345678 أو +212612345678" : "Ex: 0612345678 ou +212612345678"}
              </p>
            </div>
